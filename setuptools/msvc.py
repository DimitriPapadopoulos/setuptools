...
class SystemInfo:
    ...
    def _guess_vc_legacy(self):
        ...
        reg_path = join(self.ri.vc_for_python, f'{self.vs_ver:0.1f}')
    ...
    def WindowsSdkDir(self):  # noqa: C901  # is too complex (12)  # FIXME
        ...
        for ver in self.WindowsSdkVersion:
            ...
            loc = join(self.ri.windows_sdk, f'v{ver}')
            sdkdir = self.ri.lookup(loc, 'installationfolder')
            if sdkdir:
                break
        if not sdkdir or not isdir(sdkdir):
            # Try to get "VC++ for Python" version from registry
            path = join(self.ri.vc_for_python, f'{self.vc_ver:0.1f}')
    ...
    def WindowsSDKExecutablePath(self):
        ...
        for ver in self.WindowsSdkVersion:
            regpaths += [join(self.ri.windows_sdk, f'v{ver}A', fx)]
    ...
    def FSharpInstallDir(self):
        ...
        str
            path
        """
        path = join(self.ri.visualstudio, rf'{self.vs_ver:0.1f}\Setup\F#')
...
class EnvironmentInfo:
    ...
    def VCTools(self):
        ...
        if arch_subdir:
            tools += [join(si.VCInstallDir, f'Bin{arch_subdir}')]
    ...
    def OSLibraries(self):
        ...
        if self.vs_ver <= 10.0:
            ...
            return [join(self.si.WindowsSdkDir, f'Lib{arch_subdir}')]
    ...
    def OSIncludes(self):
        ...
        if self.vs_ver <= 10.0:
            ...
            if self.vs_ver >= 14.0:
                ...
                sdkver = ''
            return [
                join(include, f'{sdkver}shared'),
                join(include, f'{sdkver}um'),
                join(include, f'{sdkver}winrt'),
            ]
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [join(self.si.NetFxSdkDir, rf'lib\um{arch_subdir}')]
    ...
    def UCRTIncludes(self):
        ...
        return [join(include, f'{self._ucrt_subdir}ucrt')]
